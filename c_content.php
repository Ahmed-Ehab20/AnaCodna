...
<a id="level1.4" onclick="getContent('level1.4')">Operators and Errors</a>
<a href="TEST/pyQuizeC.php">Test yourself</a>
</div>
</div>
<div class="dropdown">
...
<a id="level2.3" onclick="getContent('level2.3')">Practice</a>
<a id="level2.4" onclick="getContent('level2.4')">If & Switch Statments</a>
<a href="TEST/pyQuize2C.php">Test yourself</a>
</div>
</div>
<div class="dropdown">
<button class="dropbtn">Level 3</button>
<div class="dropdown-content">
<a id="level3.1" onclick="getContent('level3.1')">If & Switch Practice</a>
<a id="level3.2" onclick="getContent('level3.2')">Loops</a>
<a id="level3.3" onclick="getContent('level3.3')">Loops Practice</a>
<a id="level3.4" onclick="getContent('level3.4')">Arrays</a>
<a href="TEST/pyQuize3C.php">Test yourself</a>
</div>
</div>
</section>
...
?>
    ...
    <script>
        ...
        function executeCode() {
            $.ajax({
                url: "/anacodna/ide/garbage/compiler.php",
                method: "POST",
                data: {
                    language: "c",
