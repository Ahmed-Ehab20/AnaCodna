...
<a id="level1.2" onclick="getContent('level1.2')">Data Types</a>
<a id="level1.3" onclick="getContent('level1.3')">Operators</a>
<a id="level1.4" onclick="getContent('level1.4')">Addition Calculator</a>
<a href="TEST/pyQuizeCplus.php">Test yourself</a>
</div>
</div>
<div class="dropdown">
<button class="dropbtn">Level 2</button>
<div class="dropdown-content">
<a id="level2.1" onclick="getContent('level2.1')">Taking Input</a>
<a id="level2.2" onclick="getContent('level2.2')">Calculator Practice</a>
<a id="level2.3" onclick="getContent('level2.3')">Conditional Statments</a>
<a id="level2.4" onclick="getContent('level2.4')">Switch Practice</a>
<a href="TEST/pyQuize2Cplus.php">Test yourself</a>
</div>
</div>
<div class="dropdown">
<button class="dropbtn">Level 3</button>
<div class="dropdown-content">
<a id="level3.1" onclick="getContent('level3.1')">Loops</a>
<a id="level3.2" onclick="getContent('level3.2')">Loop Practice</a>
<a id="level3.3" onclick="getContent('level3.3')">Arrays</a>
<a id="level3.4" onclick="getContent('level3.4')">Functions</a>
<a href="TEST/pyQuize3Cplus.php">Test yourself</a>
</div>
</div>
</section>
        ...
        document.getElementById("next").addEventListener("click", function() {
            if (currentContentIndex < contentArray.length - 1) {
                ...
                if(currentContentIndex==4){
                    window.location.assign("TEST/pyQuizeCplus.php");
                }
                else if(currentContentIndex==8){
                    window.location.assign("TEST/pyQuize2Cplus.php");
                }
                else if(currentContentIndex==8){
                    window.location.assign("TEST/pyQuize3Cplus.php");
                }
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
    ...
    <script>
        ...
        function executeCode() {
            $.ajax({
                url: "/anacodna/ide/garbage/cppcompiler.php",
                method: "POST",
                data: {
                    language: "c++",
