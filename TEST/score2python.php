	...
	<section class="quize-box">
		<div class="quizeContainer">
			...
			if ($q1 == '' || $q2 == '' || $q3 == '' || $q4 == '' || $q5 == '') {
				...
				if ($q5 == 1) { //1st option is correct
					$score++;
				}
				$score = $score	/ 5 * 100;
				if ($score < 50) {
					echo '<h2 class="quize-header">You need to score at least 50% to pass the exam.</h2>';
					echo '<h3 class="quize-titleheader"><a href="pyQuize2python.php"> Try again </a></h3>';

					require "../connection.php";
				    $email = $_SESSION['email'];
				    $sql ="UPDATE `usertable` SET `score_python`='$score' WHERE email = '$email'";
					...
					echo '<h3 class="quize-titleheader">     <a href="../user_level/level2python.php"> finish the level </a></h3>';
