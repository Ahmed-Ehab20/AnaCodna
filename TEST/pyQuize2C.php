...
<body>
    ...
    <div class="quizeContainer">
        ...
        <form action="score2C.php" method="post">
            <h3 class="quize-titleheader">Ques1 : Choose a correct statement about a C Switch Construct </h3>
            <div class="form-group">
                <ol>
                    <li>
                        <input type="radio" name="q1" value="1" />default case is optional inside switch
                    </li>
                    <li>
                        <input type="radio" name="q1" value="2" />break; causes the control to exit the switch immediately and avoid fall down to other CASE statements.
                    </li>
                    <li>
            ...
            <br />
            <div class="form-group">
                <h3 class="quize-titleheader">Ques2 : Which datatype can accept the switch statement? </h3>
                <ol>
                    <li>
            ...
            <br />
            <div class="form-group">
                <h3 class="quize-titleheader">Ques3 : What is an example of iteration in C? </h3>
                <ol>
                    <li>
                        <input type="radio" name="q3" value="1" />for
                    </li>
                    <li>
                        <input type="radio" name="q3" value="2" />if
                    </li>
                    <li>
                        <input type="radio" name="q3" value="3" />Both
                    </li>
                </ol>
            </div>
            <div class="form-group">
                <h3 class="quize-titleheader">Ques4 : How do you intialize an array in C</h3>
                <ol>
                    <li>
                        <input type="radio" name="q4" value="1" />int arr[3]=(1,2,3);
                    </li>
                    <li>
                        <input type="radio" name="q4" value="2" />int arr(3)={1,2,3};
                    </li>
                    <li>
                        <input type="radio" name="q4" value="3" />int arr[3]={1,2,3};
                    </li>
                </ol>
            </div>
            <br />
            <div class="form-group">
                <h3 class="quize-titleheader">Ques5 :Which of the following is not a logical operator? </h3>
                <ol>
                    <li>
    ...
    <script>
        function result() {
            ...
            xhr.open("POST", "score2C.php", true);
            xhr.send(null);
        }
    </script>
</body>
