		...
		<div class="quizeContainer">
			...
			if ($q1 == '' || $q2 == '' || $q3 == '' || $q4 == '' || $q5 == '') {
				...
				if ($score < 50) {
					...
					echo '<h3 class="quize-titleheader"><a href="pyQuizepython.php"> Try again </a></h3>';
					...
					echo '<h3 class="quize-titleheader">     <a href="../user_level/level1python.php"> finish the level </a></h3>';
