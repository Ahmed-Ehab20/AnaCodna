...
<head>
    ...
    <title>Python Level 2 Quiz</title>
...
<body>
    ...
    <div class="quizeContainer">
        <h1 class="quize-header">Python Level 2 Quiz</h1>
        <p class="quize-subtitle">Please fill the details and answers the all questions-</p>
        <form action="score2python.php" method="post">
            ...
            <br />
            <div class="form-group">
                <h3 class="quize-titleheader">Ques2 :What arithmetic operators cannot be used with strings in Python?</h3>
                <ol>
                    <li>
            ...
            <br />
            <div class="form-group">
                <h3 class="quize-titleheader">Ques3 : Which of the following statements is used to create an empty set in Python? </h3>
                <ol>
                    <li>
                    ...
                    <li>
                        <input type="radio" name="q3" value="3" />set()
                    </li>
                </ol>
            </div>
            <div class="form-group">
                <h3 class="quize-titleheader">Ques4 :The % operator returns the ___.</h3>
                <ol>
                    <li>
                        <input type="radio" name="q4" value="1" />Quotient
                    </li>
                    <li>
                        <input type="radio" name="q4" value="2" />Divisor
                    </li>
                    <li>
                        <input type="radio" name="q4" value="3" />Remainder
                    </li>
                </ol>
            </div>
            <br />
            <div class="form-group">
                <h3 class="quize-titleheader">Ques5 :Conditional statements are also known as ___ statements. </h3>
                <ol>
                    <li>
                        <input type="radio" name="q5" value="1" />Decision making
                    </li>
                    <li>
                        <input type="radio" name="q5" value="2" />Start control
                    </li>
                    <li>
                        <input type="radio" name="q5" value="3" />Exit control
                    </li>
                </ol>
            </div>
            <br />
    ...
    <script>
        function result() {
            ...
            xhr.open("POST", "score2python.php", true);
            xhr.send(null);
        }
    </script>
</body>
